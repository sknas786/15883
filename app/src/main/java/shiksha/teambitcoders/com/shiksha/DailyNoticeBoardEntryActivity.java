...
public class DailyNoticeBoardEntryActivity extends AppCompatActivity implements
    ...
    String colorSelect;
    String[] country = { "Exam", "Fee", "Sports","Cultural Activity","Hostel","Internship","Extra classes","Libray" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_notice_board_entry);
...
//        actionBar.setTitle("Calendar and Event");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("NoticeboardDetails");
...
//                });
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(DailyNoticeBoardEntryActivity.this, new DatePickerDialog.OnDateSetListener() {
...
//                        e1.setText("0"+selectedday + "-0" + selectedmonth + "-" + selectedyear);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Noticeboardclass noticeboardclass = new Noticeboardclass();
//                GetDataFromEditText();
                stringUniqueID = UUID.randomUUID().toString();
                noticeboardclass.setNoticeUniqueId(stringUniqueID);
                noticeboardclass.setNoticeDetails(eventStringName);
                noticeboardclass.setNoticeDate(cDate);
                noticeboardclass.setNoticeName(eventStringColor);
                ...
                databaseReference.child(StudentRecordIDFromServer).setValue(noticeboardclass);
